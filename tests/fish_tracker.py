...
model = YOLO('/home/q_hu/workspace6/MOT/ultralytics/runs/detect/train43/weights/best.pt')  # Load an official Detect model
...
results = model.track(source="/home/q_hu/workspace6/MOT/ultralytics/videos/development.mp4", show=False, tracker="bytetrack.yaml", save_txt=True, save=True, save_conf=True)  # Tracking with ByteTrack tracker
# print(results)