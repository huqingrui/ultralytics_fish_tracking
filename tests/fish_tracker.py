...
model = YOLO('path/to/pretrained_model')  # Load an official Detect model
...
results = model.track(source="path/to/video", show=False, tracker="bytetrack.yaml", save_txt=True, save=True, save_conf=True)  # Tracking with ByteTrack tracker
# print(results)
